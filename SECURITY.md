...
Replace this section with the supported versions for `agent-qc`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `agent-qc` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in agent-qc.
