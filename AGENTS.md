# Agent Operating Instructions for agent-qc

This file defines how AI agents and human maintainers should work in `agent-qc`.
...
6. Run `pnpm test` or a smaller targeted check when appropriate.
7. Commit atomically.
